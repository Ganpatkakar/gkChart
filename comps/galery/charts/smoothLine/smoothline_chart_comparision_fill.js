...
export default class SmoothlineChartComparisionFill extends Component {
  componentDidMount = () => {
...
<html lang="en">
  ...
  <body>
    <kakarChart id="smoothLineComparisionFill" style="height:350px; width:100%;"></kakarChart>
