...
export default class LineChartComparisionFill extends Component {
  componentDidMount = () => {
...
<html lang="en">
  ...
  <body>
    <kakarChart id="chartlineComparisionFill" style="height:350px; width:100%;"></kakarChart>
    <script type="text/javascript" src="gk-chart.mi.js"></script>
  </body>
</html>`}</xmp>
                </pre>
              </Tab>
